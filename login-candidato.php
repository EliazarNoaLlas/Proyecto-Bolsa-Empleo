                ...
                <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible"
                    ...
                    <div class="content content-full">
                        ...
                        <form class="js-validation-signin px-30"
                            ...
                            <input type="hidden" name="codigo" value="<?php if (isset($_GET['id'])) {
                                echo $_GET['id'];
                            } ?>">
                            <input type="hidden" name="direccionar" value="<?php if (isset($_GET['direccionar'])) {
                                echo $_GET['direccionar'];
                            } ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-30 text-center">
                                    ...
                                    <a class="link-effect text-dark mr-10 mb-5 d-inline-block" href="recuperacion">
                                        <b style="font-size: 16px;"><i class="fa fa-warning mr-5"></i> ¿Olvidaste la
                                            contraseña?</b>
                                    </a>

                                    <a class="link-effect text-dark mr-10 mb-5 d-inline-block"
                                       href="crear-cuenta-candidato">
                                        <b style="font-size: 16px;"><i class="fa fa-user-plus mr-5"></i> Crear
                                            Cuenta</b>
                                    </a>
...
<!--                                         data-class="animated flipInY">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">Bienvenido a
                                        BOLSA LABORAL C.A! </h3>
                                    ...
                                    <P style="text-align: left;" data-toggle="appear" data-class="animated fadeInUp">
                                        Recuerda dar clic que no es un correo no deseado para que puedas recibir las
                                        notificaciones.</P>
