...
?>
    ...
    <main id="main-container">
            ...
            <div class="">
                <div class="content content-top text-center overflow-hidden">
                    <div class="pt-40 pb-20">
                        ...
                        <h2 class="invisible" style="color: white;" data-toggle="appear" data-class="animated fadeInUp">
                            ¡ Tu panel empresarial <br> <?php echo $Empresa; ?> ! </h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="margin-right:2%; margin-left:2%;">
            ...
            <div class="row gutters-tiny js-appear-enabled animated bounceInRight" data-toggle="appear"
                 data-class="animated bounceInRight">
                        ...
                        <div class="block-content block-content-full">
                            <div class="block block-transparent  d-flex align-items-center w-100" class="cuadros">
                                <div class="block-content block-content-full">
                                    ...
                                    <p class="text-center">
                                        <a class="img-link" href="javascript:void(0)" data-toggle="modal"
                                        ...
                                        <div class="row items-push">
                                            <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <a href="actualizar-cuenta"
                                                       class="btn btn-hero btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"><i
                                                                class="fa fa-user"></i> Cuenta Usuario</a>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <a href="javascript:void(0)"
                                                   ...
                                                   data-toggle="modal" data-target="#modal-terms2"><i
                                                            class="fa fa-cloud-upload"></i> Logo Empresa</a>
                                                <br>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="block block-transparent  d-flex align-items-center w-100" class="cuadros">
                                <div class="block-content block-content-full" style="margin-bottom: 13px;">
                                    ...
                                    <div class="py-15 px-20 clearfix border-black-op-b">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white">Logo
                                            empresa: <?php if ($logo == "pordefecto.jpg") {
                                                echo "No hay logo subido";
                                            } ?></div>
                                        <hr>
                                        ...
                                        <div class="col-md-12 col-xl-12">
                                            ...
                                            <div class="block-content p-0 overflow-hidden text-center">
                                                <?php if ($logo == "pordefecto.jpg") {
                                                    echo "<p class='text-white'>No hay logo subido</p>";
                                                } else { ?>

                                                    <a class="img-link" href="javascript:void(0)" class="text-center">
                                                        <img src="../../main/img/LogosEmpresas/<?php echo $logo ?>"
                                                             class="img-fluid" id="imglogo">
                                                    </a>
                                    ...
                                    <div class="py-15 px-20 clearfix border-black-op-b">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white">Perfil Empresa
                                        </div>
                                        <hr>
                                    ...
                                    <div class="py-15 px-20 clearfix border-black-op-b">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white">Estado de la
                                            empresa
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h6 class="text-white">Fecha
                                                    Renovada: <?php echo $FechaRegistro; ?></h6>
                                            </div>

                                            <div class="col">
                                                <h6 class="text-white">Fecha
                                                    Vencimiento: <?php echo $FechaVencimiento; ?></h6>
    ...
    <!-- Terms Modal -->
    <div class="modal fade" id="modal-terms2" tabindex="-1" role="dialog" aria-labelledby="modal-terms2"
         aria-hidden="true">
...
<!--                                     data-class="animated flipInY">-->
                                <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                    data-class="animated flipInY" id="titulos" style="color: #0B3486;">sube tu logo de
                                    empresa </h3>
                                <p>Nota:El logo debe contener las dimensiones de 100 x 100</p>
                                <form method="POST" action="Modelos/ModelosImagenes/CambiarImagenEmpresa.php"
                                    ...
                                    <p class="text-center">
                                        ...
                                        <button type='submit' class='btn btn-sm btn-hero btn-noborder mb-10 mx-5'
                                                name='Guardar' id="valida2r"
                                                style="background:#FCC201; color:#0B3486; font-weight: bold;">
