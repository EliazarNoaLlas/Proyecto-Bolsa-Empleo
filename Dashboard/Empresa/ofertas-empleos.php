...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Oferta de empleos</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right:2%; margin-left:2%;">
        ...
        <div class="content">
            ...
            <h5 style="font-family: sans-serif; color: black;">Información General</h5>
            <hr>
            <div class="row">
                <!-- Row #1 -->
            ...
            <p style="font-size: 18px; color: black; font-family: sans-serif;">A continuación se muestran las ofertas
                publicadas las cuales has publicado todo en este tiempo, desde la más reciente a la más antigua.
            </p>
