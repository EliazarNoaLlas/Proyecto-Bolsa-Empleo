...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">ANEXAR DOCUMENTOS </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right:2%; margin-left:2%;">
        ...
        <div class="content py-5 text-center">
            <br>
            <a href="referencia?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
                        class="si si-action-undo fa-2x5"> </i> Retroceder</a>
            <a href="Modelos/ModelosPerfil/Cambiar_estado_perfil.php?id=<?php echo $IDUser; ?>"
               class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> Finalizar</a>
        </div>
                ...
                <div class="block block-rounded block-themed">
                    <div class="block-header bg-gd-primary">
                        ...
                        <div class="block-options">
                            ...
                            <form action="Modelos/ModelosDocumentos/guardardocumento.php" method="POST"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="alert alert-primary text-justify indicaciones" role="alert">
                            <i class="fa fa-info-circle fa-2x5 text-dark"></i>
                            Indicaciones: <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?> :En esta sección
                            podrás agregar los docuemtnos como la <b style="color:#0B3486;">solvencia de la policía,
                                documentos de identidad y anexar tu curriculum vitae </b> y los reclutadores
                            visualizarán los archivos <b style="color:#0B3486;">Solo documentos PDF</b>.
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="nombre" name="nombre"
                                       placeholder="Nombre del archivo solo PDF" required>
                            </div>
                        </div>
...
<!--                                         style="height: 100px; width: 250px;">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">anexar
                                        documentos</h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">

                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?> es<b
                                                style="color:#0B3486;"> Opcional:</b> agregar tu <b
                                                style="color:#0B3486;">curriculum vitae</b> en la plataforma solo se <b
                                                style="color:#0B3486;">acepta PDF.</b>
                                        en el apartado donde dice nombre del archivo puedes agregar lo siguiente <b
                                                style="color:#0B3486;">curriculum_vitae_<?php echo $PrimerNombre[0] . "_" . $PrimerApellido[0]; ?></b>

                                        <br><br>
                                        En este apartado puede añadir diferentes documentos como la <b
                                                style="color:#0B3486;">solvencia de la policía, documentos de identidad
                                            u otro tipo de documentantación </b> que te soliciten.
                                        <br><br>

                                    </p>

                                    <a class="btn  btn-alt-primary " href="#" data-dismiss="modal"
...
<?php if (isset($_GET['documentoError'])) {
    echo "<script>swal({title:'Advertencia',text:'Debe anexar curriculum vitae. Recuerda poner el nombre del archivo curriculum vitae " . $PrimerNombre[0] . " " . $PrimerApellido[0] . " ',type:'warning'  });</script>";
} ?>
