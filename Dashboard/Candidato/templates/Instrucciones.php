                                ...
                                <div class="row justify-content-center text-center">
                                    <div class="col-md-10 col-lg-8">
                                        ...
                                        <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                            data-class="animated flipInY" id="titulos" style="color: #0B3486;">
                                            Bienvenido al panel principal! </h3>

                                        <p class="text-center" style="text-align: justify;" data-toggle="appear"
                                           data-class="animated fadeInUp">
                                            <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Cualquier tipo
                                            de información que esté relacionada con tus datos personales no será
                                            compartida ni publicada en esta plataforma.
                                            <br>

                                            <a href="politicas-plataforma" class="text-center" data-toggle="appear"
                                               data-class="animated fadeInUp" target="_blank">Leer Póliticas de la
                                                plataforma.</a>
...
<!--                                        <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"-->
<!--                                            data-class="animated flipInY" id="titulos" style="color: #0B3486;">-->
<!--                                            ¡Bienvenido a BOLSA LABORAL C.A.! </h3>-->
<!---->
<!---->
<!--                                    </div>-->
<!--                                </div>-->
...
<!--                            -->
<!--                                                            <h3 class="font-size-h4 font-w300 mb-5">Recuerda Completar tu perfil: -->
<!--                            --><?php //echo $PrimerNombre[0] ?><!-- <i class="si si-note  text-primary"></i></h3>-->
