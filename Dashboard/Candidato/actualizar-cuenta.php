        ...
        <div class="">
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    ...
                    <h2 class="h4 font-w400  invisible" id="titulos" style="color: white;" data-toggle="appear"
                        data-class="animated fadeInUp">Actualizar la cuenta <?php echo $PrimerNombre[0] ?> ! </h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="block-content">
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-user"></i>
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                           placeholder="nombre usuario" value="<?php echo $NombresUser ?>" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-user"></i>
                                    ...
                                    <input type="text" class="form-control" id="apellidos" name="apellidos"
                                           placeholder="nombre usuario" value="<?php echo $ApellidosUser ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="submit" name="Guardar" id="Guardar" value="Actualizar nombres"
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email"
                                           disabled value="<?php echo $CorreoUser ?>">
                    ...
                    <span class="input-group-text">
                      <span id="MostrarPossword" class="fa fa-eye-slash icon"></span>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="submit" name="btnpassword" id="btnpassword" value="Actualizar contraseña"
