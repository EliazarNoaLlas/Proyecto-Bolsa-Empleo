...
?>
    ...
    <header class="resume-header pt-4 pt-md-0">
        ...
        <div class="Contedor-header">
            ...
            <p class="cabecera-p">Correo electrónico: <a href="mailto:<?php echo $Email ?>"
                                                         style="color: white;"><?php echo $Email ?></a> <br> Número
                movil:
                <?php echo $Celular ?>
            <p>
    ...
    <div
        ...
        <p class="acerca">E-mail alternativo <br><a
                    href="mailto:<?php echo $CorreoAlternativo ?>"><?php echo $CorreoAlternativo ?></a></p>
