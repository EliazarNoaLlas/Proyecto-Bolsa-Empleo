   ...
   //file_put_contents($filename, $pdf);
	//$dompdf->stream($filename);
			...
			try {
			    ...
			    <img src="https://webmakersv.com/recursosMundoEmpleo/logo.JPG" alt="Logo del BOLSA LABORAL" width="250" height="80" style="display: block;" /> <hr style="margin-left: 25px;margin-right: 25px;">
			    ...
			    <p style="margin: 0; text-align: justify;">Mensaje Enviado Por: '.$NombresUser.'<br><br> te saluda el equipo de BOLSA LABORAL:  <br><br>Hemos recibido un pedido para enviarte curriculum vitae en pdf. Si no has iniciado este pedido, puedes simplemente ignorar este mensaje y ninguna acción será tomada. <br> </p>
